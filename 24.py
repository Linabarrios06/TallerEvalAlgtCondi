...
def leap (year):
    ...
    if year % 100 == 0 and year % 400 == 0:
        print(f"{year} this year is a leap year") #este año es bisiesto
        
    else:
        print("This year is not a leap year") #este año no es bisiesto

leap(year = int(input("Input a year: "))) #entradas al año 
