...
salary = int(input("Insert your salary: ")) #introduzca su salario 
...
if salary <= 1000000:
    print(f"Your finaly salary is: {total1}") #su salario final es {}
    
elif salary in range (1000001,1999999):
    print(f"Your finaly salary is: {total2}") #su salario final es {}
    
elif salary >= 2000000:
    print(f"Your finaly salary is: {total3}") #su salario final es {}
